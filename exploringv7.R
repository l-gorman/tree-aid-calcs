...
test_result <- ntfp_sold_and_consumed_calculation(
    data=tree_aid_df,
...
# Loop amount sold calculation
fp_sold_calc <-  function(
    tree_aid_df,
    column_a, # fruit_amount_kg
    column_b, # fruit_sold_prop_numeric
    new_column_name
){
  #Checking whether the columns are in the dataset
  missing_columns <- check_columns_in_data(tree_aid_df,
                                           loop_columns = c(column_a, column_b),
                                           warning_message = "Cannot calculate NTFP amount sold"
  )
  ...
  ntfp_amount_sold <- sapply(c(1:number_of_loops), function(x) multiply(tree_aid_df, column_a = column_a, column_b = column_b, loop_number = x))
  colnames(ntfp_amount_sold) <- paste0(new_column_name, "_", c(1:number_of_loops))

  # Add back into the original dataset
  ntfp_amount_sold <- tibble::as_tibble(ntfp_amount_sold)
  tree_aid_df <- add_column_after_specific_column(
    data = tree_aid_df,
    new_data = ntfp_amount_sold,
    new_column_name = new_column_name,
    old_column_name = column_b,
    loop_structure = T
  )
...
# Eaten
tree_aid_df$fruit_amount_kg_1*tree_aid_df$fruit_eaten_prop_numeric_1
tree_aid_df$fruit_amount_kg_2*tree_aid_df$fruit_eaten_prop_numeric_2
tree_aid_df$fruit_amount_kg_3*tree_aid_df$fruit_eaten_prop_numeric_3

tree_aid_df$nut_amount_kg_1*tree_aid_df$nut_eaten_prop_numeric_1
tree_aid_df$nut_amount_kg_2*tree_aid_df$nut_eaten_prop_numeric_2
tree_aid_df$nut_amount_kg_3*tree_aid_df$nut_eaten_prop_numeric_3

tree_aid_df$leaves_amount_kg_1*tree_aid_df$leaves_eaten_prop_numeric_1
tree_aid_df$leaves_amount_kg_2*tree_aid_df$leaves_eaten_prop_numeric_2
tree_aid_df$leaves_amount_kg_3*tree_aid_df$leaves_eaten_prop_numeric_3

tree_aid_df$bark_amount_kg_1*tree_aid_df$bark_eaten_prop_numeric_1
tree_aid_df$bark_amount_kg_2*tree_aid_df$bark_eaten_prop_numeric_2
tree_aid_df$bark_amount_kg_3*tree_aid_df$bark_eaten_prop_numeric_3

tree_aid_df$roots_amount_kg_1*tree_aid_df$roots_eaten_prop_numeric_1
tree_aid_df$roots_amount_kg_2*tree_aid_df$roots_eaten_prop_numeric_2
tree_aid_df$roots_amount_kg_3*tree_aid_df$roots_eaten_prop_numeric_3

tree_aid_df$gum_amount_kg_1*tree_aid_df$gum_eaten_prop_numeric_1
tree_aid_df$gum_amount_kg_2*tree_aid_df$gum_eaten_prop_numeric_2
tree_aid_df$gum_amount_kg_3*tree_aid_df$gum_eaten_prop_numeric_3
